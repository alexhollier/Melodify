                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button 
                            ...
                            onPress={() => mixolydian.play()} 
                        />
                        <Button 
                            color='#F44336' 
                            title="Pause Mixolydian" 
                            onPress={() => mixolydian.pause()} 
                        />
                    </View>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button 
                            color='#4CAF50' 
                            title="Play Aeolian" 
                            onPress={() => aeolian.play()} 
                        />
                        <Button 
                            color='#F44336' 
                            title="Pause Aeolian" 
                            onPress={() => aeolian.pause()} 
                        />
                    </View>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button 
                            color='#4CAF50' 
                            title="Play Phrygian" 
                            onPress={() => phrygian.play()} 
                        />
                        <Button 
                            color='#F44336' 
                            title="Pause Phrygian" 
                            onPress={() => phrygian.pause()} 
                        />
                    </View>
                </View>
                ...
                <View style={styles.card}>
                    ...
                    <View style={styles.buttonContainer}>
                        <Button 
                            color='#4CAF50' 
                            title="Play Locrian" 
                            onPress={() => locrian.play()} 
                        />
                        <Button 
                            color='#F44336' 
                            title="Pause Locrian" 
                            onPress={() => locrian.pause()} 
                        />
                    </View>
                </View>
